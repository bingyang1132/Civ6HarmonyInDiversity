...
values
    ...
    ("LOC_ABILITY_HD_CAN_MOVE_AFTER_ATTACK_DESCRIPTION",                      "Can move after attacking."),
    ...
    ("LOC_ABILITY_MAGNUS_TRAINED_SETTLER_MOVEMENT_DESCRIPTION",                "+2 [ICON_MOVEMENT] Movement from Magnus's Training"),
    ("LOC_ABILITY_ARTHASHASTRA_EXTRA_MOVEMENT_DESCRIPTION",                   "+1 [ICON_MOVEMENT] Movement.(Arthashastra)"),
    ...
    ("LOC_ABILITY_STABLE_TRAINED_UNIT_STRENGTH_DESCRIPTION",                  "+2 [ICON_Strength] Combat Strength from training in Stable"),
    ...
    ("LOC_ABILITY_JUST_WAR_RELIGIOUS_ALL_COMBAT_BUFF_DESCRIPTION",            "Itinerant Preachers: Combat units gain +5 [ICON_Strength] Combat Strength when their tile have a religious unit."),
    ...
    ("LOC_ABILITY_PUSHBACK_DESCRIPTION",                                      "Pushes defending enemy units back from their hex in any battle where they score more damage. 50% less [ICON_Strength] Combat Strength reduction from being injured."),
    ("LOC_ABILITY_TERRITORY_COMBAT_HD_DESCRIPTION",                           "Bannockburn: +4 [ICON_Strength] Combat Strength in your territory."),
    ("LOC_ABILITY_TERRITORY_COMBAT_HD_TEXT",                                  "from Bannockburn"),
    ("LOC_ABILITY_NAVAL_RAIDER_BONUS_HD_DESCRIPTION",                         "Naval Raider units receive +2 [ICON_Strength] Combat Strength. (Francis·Drake)"),
    ("LOC_ABILITY_CHING_SHIH_PLUNDER_BONUS_DESCRIPTION",                      "+100% Rewards for plundering trade routes. (Ching Shih)"),
    ("LOC_ABILITY_ARCHAEOLOGIST_IGNORE_HILLS_HD_DESCRIPTION",                 "Ignore [ICON_MOVEMENT] movement penalty from Hills. (Terracotta Army)"),
    ("LOC_ABILITY_ARCHAEOLOGIST_IGNORE_FOREST_HD_DESCRIPTION",                "Ignore [ICON_MOVEMENT] movement penalty from Forest and Jungle. (Terracotta Army)"),
    ...
    ("LOC_HD_UNOBSTRUCTED_VIEW_DESCRIPTION",                                  "Sight range unobstructed by terrain."),
    ("LOC_HD_SEE_HIDDEN_DESCRIPTION",                                         "Reveal stealth units on the map within sight range."),
    ("LOC_SPY_OBSERVER_SPYGLASS_SIGHT_DESCRIPTION",                           "Spyglass:+2 sight range."),    
    ("LOC_HD_SPY_PATHFINDER_MOVEMENT_PREVIEW_TEXT",                           "from your Pathfinder"),   
    ...
    ("LOC_ABILITY_ENGLAND_IGNORE_EMBARK_DISEMBARK_COST_NAME",                 "Royal Navy Dockyard"),
    ("LOC_ABILITY_ENGLAND_IGNORE_EMBARK_DISEMBARK_COST_DESCRIPTION",          "Ignore additional [ICON_MOVEMENT] Movement costs from embarking and disembarking."),
    ("LOC_ABILITY_SHARED_MOVEMENT_DESCRIPTION",                               "Escorted units with it move at the same speed."),
    ("LOC_ABILITY_ADJUST_ATTACK_RANGE_DESCRIPTION",                           "+1 [ICON_RANGE] Range."),
...
values
    ...
    ("zh_Hans_CN",  "LOC_ABILITY_CIVILIAN_AND_RECON_BONUS_SIGHT_DESCRIPTION",                "舍农索城堡：黑王后的情报支援使视野范围+1。"),
    ("zh_Hans_CN",  "LOC_ABILITY_SPY_BONUS_SIGHT_DESCRIPTION",                               "舍农索城堡：黑王后的情报支援使视野范围+3。"),
    ("zh_Hans_CN",  "LOC_SPY_OBSERVER_SPYGLASS_SIGHT_DESCRIPTION",                           "以望远镜鸟瞰，+2视野。"),
    ("zh_Hans_CN",  "LOC_ABILITY_AMANI_FERR_PROMOTION_DESCRIPTION",                          "本地线人：阿玛尼的训练使获得免费晋升。"),
    ("zh_Hans_CN",  "LOC_ABILITY_CHANCERY_FERR_PROMOTION_DESCRIPTION",                       "当心脚下：在外交办中训练获得免费晋升。"),
    ("zh_Hans_CN",  "LOC_ABILITY_MILLITARY_ENGINEER_IGNORE_TERRAIN_DESCRIPTION",             "无视地形、地貌和河流对 [ICON_MOVEMENT] 移动力的减益。"),
    ("zh_Hans_CN",  "LOC_ABILITY_RAMSES_RIVER_PATROL_DESCRIPTION",                           "无视地形、地貌和河流对 [ICON_MOVEMENT] 移动力的减益。"),
    ("zh_Hans_CN",  "LOC_ABILITY_GUILDMASTER_TRAINED_BUILDER_MOVEMENT_DESCRIPTION",          "梁训练：永久+1 [ICON_MOVEMENT] 移动力"),
    ("zh_Hans_CN",  "LOC_ABILITY_MAGNUS_TRAINED_SETTLER_MOVEMENT_DESCRIPTION",              "马格努斯训练：永久+2 [ICON_MOVEMENT] 移动力"),
    ("zh_Hans_CN",  "LOC_ABILITY_ARTHASHASTRA_EXTRA_MOVEMENT_DESCRIPTION",                   "+1 [ICON_MOVEMENT] 移动力。（政事论）"),
    ...
    ("zh_Hans_CN",  "LOC_ABILITY_TRAINED_LIGHT_CAVALRY_PILLAGE_LESS_MOVEMENT_DESCRIPTION",   "打草谷训练：劫掠只消耗1 [ICON_MOVEMENT] 移动力"),
    ...
    ("zh_Hans_CN",  "LOC_ABILITY_STABLE_TRAINED_UNIT_STRENGTH_DESCRIPTION",                  "在马厩中训练获得的+2 [ICON_Strength] 战斗力"),
    ...
    ("zh_Hans_CN",  "LOC_ABILITY_JUST_WAR_RELIGIOUS_ALL_COMBAT_BUFF_DESCRIPTION",            "随军牧师：同一单元格内的战斗单位+5 [ICON_Strength] 战斗力。"),
    ...
    ("zh_Hans_CN",  "LOC_ABILITY_PUSHBACK_DESCRIPTION",                                      "如果在战斗中输出的伤害值更高，则将敌方防御单位推至其后方的格位上。受伤后的 [ICON_Strength] 战斗力减益减少50%。"),
    ("zh_Hans_CN",  "LOC_ABILITY_TERRITORY_COMBAT_HD_DESCRIPTION",                           "班诺克本：在国境内时+4 [ICON_Strength] 战斗力。"),
    ("zh_Hans_CN",  "LOC_ABILITY_TERRITORY_COMBAT_HD_TEXT",                                  "来自班诺克本"),
    ("zh_Hans_CN",  "LOC_ABILITY_NAVAL_RAIDER_BONUS_HD_DESCRIPTION",                         "海军袭击者+2 [ICON_Strength] 战斗力。 (弗朗西斯·德瑞克)"),
    ("zh_Hans_CN",  "LOC_ABILITY_CHING_SHIH_PLUNDER_BONUS_DESCRIPTION",                      "掠夺贸易路线时+100%收益。（郑一嫂）"),
    ("zh_Hans_CN",  "LOC_ABILITY_ARCHAEOLOGIST_IGNORE_HILLS_HD_DESCRIPTION",                 "无视丘陵带来的 [ICON_Movement] 移动力减益。 (兵马俑)"),
    ("zh_Hans_CN",  "LOC_ABILITY_ARCHAEOLOGIST_IGNORE_FOREST_HD_DESCRIPTION",                "无视森林和雨林带来的 [ICON_Movement] 移动力减益。 (兵马俑)"),
    ...
    ("zh_Hans_CN",  "LOC_ABILITY_ENGLAND_IGNORE_EMBARK_DISEMBARK_COST_NAME",                 "皇家海军船坞"),
    ("zh_Hans_CN",  "LOC_ABILITY_ENGLAND_IGNORE_EMBARK_DISEMBARK_COST_DESCRIPTION",          "忽略来自上船和下船的额外 [ICON_MOVEMENT] 移动力消耗。"),
    ("zh_Hans_CN",  "LOC_ABILITY_SHARED_MOVEMENT_DESCRIPTION",                               "护送的单位将以同样的速度移动。"),
    ("zh_Hans_CN",  "LOC_ABILITY_ADJUST_ATTACK_RANGE_DESCRIPTION",                           "+1 [ICON_RANGE] 射程。"),
...
values
    ...
    ("LOC_ABILITY_NAGAO_DESCRIPTION",                                         "+10 [ICON_Strength] Combat Strength when defending against ranged units.[NEWLINE][ICON_Bullet]Can see through features[NEWLINE][ICON_Bullet]+3 [ICON_Strength] Combat Strength when fighting in Rainforest or Woods tiles."); -- Can move through Woods and Rainforest without [ICON_Movement] Movement penalty.
...
--间谍:新增间谍完成进攻性任务后+1时代的分，4级间谍获得+3时代得分
insert or replace into EnglishText
    (Tag,                                                                       Text)
values
    ("LOC_NOTIFIER_OFFENSIVE_MISSION_ERASCORE",                                 "Gain +1 Era Score from Offensive Spy Mission"),
    ("LOC_NOTIFIER_LEGENDARY_SPY_ERASCORE",                                     "Gain +3 Era Score from Legendary Spy");
insert or replace into LocalizedText
    (Language,      Tag,                                                        Text)
values
    ("zh_Hans_CN",  "LOC_NOTIFIER_OFFENSIVE_MISSION_ERASCORE",                  "+1时代得分来自进攻性间谍任务"),
    ("zh_Hans_CN",  "LOC_NOTIFIER_LEGENDARY_SPY_ERASCORE",                      "+3时代得分来自传奇间谍");