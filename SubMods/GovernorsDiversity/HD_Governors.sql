...
values
	('MAGNUS_TRAINED_SETTLER_MOVEMENT',				'ModifierId',		'MAGNUS_TRAINED_SETTLER_MOVEMENT_MODIFIER'),
	('MAGNUS_TRAINED_SETTLER_MOVEMENT_MODIFIER',	'AbilityType',		'ABILITY_MAGNUS_TRAINED_SETTLER_MOVEMENT'),
